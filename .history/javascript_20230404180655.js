...
class EmotionObject{
  ...
  getHtmlContainerString(wordArr) {
    let containerOnomaSec =
      `
      <div id="${this.emotion}" class="container text-left px-3 pb-4 d-md-flex flex-md-wrap justify-content-md-center" style="background-color: ${this.color}">
...
let categoryContainer = "<div class='container d-flex justify-content-center flex-wrap'>";
for (let i = 0; i < emotions.length; i++){
  let currFace = HelperFunction.faceSelect(emotions[i]["emotion"]);

  categoryContainer +=
    `
      <div class="col-12 col-md-6 col-lg-3 p-4 m-4 text-center" style="background-color: ${emotions[i]["color"]}; color: white;">
